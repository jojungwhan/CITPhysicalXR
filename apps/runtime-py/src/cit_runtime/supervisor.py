...
_SOURCE_PRIORITY: Mapping[str, CommandPriority] = {
    ...
    "instructor": CommandPriority.INSTRUCTOR_STOP_ALL,
...
class SafetySupervisor:
    ...
    def _physical_movement_denial(
        ...
        *,
        ...
        if policy.require_deadman and not command.safetyContext.deadmanActive:
            return self._deny(
                priority,
                "SAFETY_POLICY_DENIED",
                "Physical movement requires an active dead-man control",
